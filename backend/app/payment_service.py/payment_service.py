...
class PaymentService:
    ...
    @staticmethod
    def create_upi_payment(db: Session, user_id: int, tournament_id: int, amount: float, upi_id: str) -> Payment:
    ...
    @staticmethod
    def create_binance_payment(db: Session, user_id: int, tournament_id: int, amount: float, transaction_hash: str) -> Payment:
        commission, net_amount = PaymentService.calculate_commission(amount)
