    ...
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <div className="max-w-md mx-auto">
        ...
        <form onSubmit={submit} className="mt-4 bg-gray-800 p-4 rounded">
          ...
          <input className="w-full p-2 mt-1 rounded bg-gray-700" value={email} onChange={e=>setEmail(e.target.value)} />
          <label className="block mt-3">Password</label>
          <input type="password" className="w-full p-2 mt-1 rounded bg-gray-700" value={pass} onChange={e=>setPass(e.target.value)} />
